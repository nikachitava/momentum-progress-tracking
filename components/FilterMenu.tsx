...
import FilterMenuSelectedOptions from "./FilterMenuSelectedOptionsContainer";
        ...
        <>
            <div className="relative max-w-[688px] flex items-center justify-between border border-[#DEE2E6] rounded-[10px] mt-[52px]">
                ...
                <FilterMenuItem
                    ...
                    children={
                        <PriorityDropdownContent priorities={priorities} />
                    }
                />
                <FilterMenuItem
                    title="თანამშრომელი"
                    ...
                    children={
                        <EmployeesDropdownContent employees={employees} />
                    }
                />
            </div>
            <FilterMenuSelectedOptions />
        </>
    );
};
